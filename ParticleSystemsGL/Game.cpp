...
Game::Game(Camera* camera, TextureLoader* texture_loader, ShaderLoader* shader_loader) : m_camera(camera), m_texture_loader(texture_loader), m_shader_loader(shader_loader){
    ;
}
